 ...
 */
public class slimeGreen extends Actor
{
    ...
    public void act() {
        ...
        if (estaNoChao && Greenfoot.isKeyDown("w")) {
            // Inicia o pulo
            iniciarPulo();
        }
    ...
    public void movimento(){
        ...
        if(Greenfoot.isKeyDown("f")&&(sTimer == 0)){
            sTimer ++;
            getWorld().addObject(new atackGreen(), getX() +50,
            getY() +30);
        } else {
    ...
    public void acertaralvo() {
        Actor b = getOneIntersectingObject(slimeRed.class);
        if (b !=null){
